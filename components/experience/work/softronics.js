...
const Softronics = () => (
    <StyledParagraph>
        ...
        <p>
            {'Worked with embedded software engineers on research and development projects. ' +
                'Got to experiment with writing embedded interfaces in C for GPS receivers and high frequency radio receivers.'}
        </p>
